...
4. restart VM and Delete ~/.gsutil . ```rm -rf ~/.gsutil```
...
```bash
URL="spark://de-zoomcamp.us-east5-c.c.zoomcamp-448807.internal:7077"
...
* `--input_green=gs://dezoomcamp_module5/pq/green/2021/*/`
* `--input_yellow=gs://dezoomcamp_module5/pq/yellow/2021/*/`
* `--output=gs://dezoomcamp_module5/report-2021`
...
gcloud dataproc jobs submit pyspark \
    ...
    --region=us-central1 \
    gs://dezoomcamp_module5/code/06_spark_sql.py \
    -- \
        --input_green=gs://dezoomcamp_module5/pq/green/2020/*/ \
        --input_yellow=gs://dezoomcamp_module5/pq/yellow/2020/*/ \
        --output=gs://dezoomcamp_module5/report-2020
```
